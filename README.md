# 🔍 BiasLens – Ethical AI Bias Detection System
...
- ⚖️ Model fairness evaluation using group-wise performance metrics
- 🧠 Explainable AI (XAI) to identify why bias occurs
- 🛠️ Actionable bias mitigation recommendations
- 🎨 Clean and minimal dashboard UI for non-technical users
